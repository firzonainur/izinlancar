                        ...
                        <div class="network-info-tabs">
                            ...
                            <div class="network-tabs tabs-box">
                                ...
                                <div class="tabs-content">
                                    ...
                                    <!-- Tab -->
                                    <div class="tab" id="network-two">
                                        <div class="content">
                                        	<div class="row clearfix">
                                            	<div class="column col-md-6 col-sm-12 col-xs-12">
                                                	<div class="text">198 Tech Road Bridge Str, Newyork 10026 United States.</div>
                                                </div>
                                                <div class="column col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <!-- Tab -->
                                    <div class="tab" id="network-three">
                                        <div class="content">
                                        	<div class="row clearfix">
                                            	<div class="column col-md-6 col-sm-12 col-xs-12">
                                                	<div class="text">Tech Road Bridge Str, Newyork 10026 United States.</div>
                                                </div>
                                                <div class="column col-md-6 col-sm-12 col-xs-12">
                                                	<div class="text">Ph: 936.452.8005 <br> E: Mailus@ikonteam.com</div>
                                                </div>
